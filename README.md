- **[Composis](https://composis.tech)** → Describe an idea and get a complete system design, recommended open source stack, architecture guidance, and deployment options, all powered by open source repositories.
- **[Arcade](https://joinarcade.in)** → Multi-tenant SaaS for restaurants to manage tables, bookings, loyalty programs, rewards, customer engagement, and personalized coupons.
